...
class UNetTransformer_SC(nn.Module):
    """ 
    Same as Unet6_MHSA_skipconv but contains ReLU activation in the output layer.
    """
    def __init__(self, num_heads = 2, n_input_channels:int=1,
                fusion_module: str = 'ConcatenationFusion',
                device=torch.device('cuda:0')
            ) -> None:
        super(UNetTransformer_SC, self).__init__()
        self.device = device
        ...
        self.skip31 = simple_conv(ch_in=32, ch_out=32) # for enc32: 32 out channels
        self.skip321 = simple_conv(ch_in=32, ch_out=32) # for skip41: 32 out channels
        self.skip322 = simple_conv(ch_in=32, ch_out=32) # for skip41: 32 out channels
        self.skip331 = simple_conv(ch_in=64, ch_out=32) # input is the concat of output of skip421, skip422
        self.skip332 = conv_block(ch_in=64, ch_out=32) # input is the concat of output of skip421, skip422
        self.skip34 = simple_conv(ch_in=64, ch_out=32) # input is the concat of output of skip431, skip432

        self.skip21 = simple_conv(ch_in=16, ch_out=16) # for enc22: 16 out channels
        self.skip221 = simple_conv(ch_in=16, ch_out=16) # for skip51: 16 out channels
        self.skip222 = simple_conv(ch_in=16, ch_out=16) # for skip51: 16 out channels
        self.skip231 = simple_conv(ch_in=32, ch_out=16) # input is the concat of output of skip521, skip522
        self.skip232 = conv_block(ch_in=32, ch_out=16) # input is the concat of output of skip521, skip522
        self.skip24 = simple_conv(ch_in=32, ch_out=16) # input is the concat of output of skip531, skip532
        
        self.skip11 = simple_conv(ch_in=8, ch_out=8) # for enc12: 8 out channels
        self.skip121 = simple_conv(ch_in=8, ch_out=8) # for skip61: 8 out channels
        self.skip122 = simple_conv(ch_in=8, ch_out=8) # for skip61: 8 out channels
        self.skip131 = simple_conv(ch_in=16, ch_out=8) # input is the concat of output of skip621, skip622
        self.skip132 = conv_block(ch_in=16, ch_out=8) # input is the concat of output of skip621, skip622
        self.skip14 = simple_conv(ch_in=16, ch_out=8)# input is the concat of output of skip631, skip632
