...
class UNetTransformer_SC_Large(nn.Module):
    def __init__(self, num_heads = 2, n_input_channels:int=1,
        ...
        self.pos_encoding = PositionalEncoding(self.device)
        self.mhsa = MultiHeadSelfAttention(512, num_heads)
        ...
        self.skip31 = simple_conv(ch_in=64, ch_out=64) # for enc64: 64 out channels
        self.skip321 = simple_conv(ch_in=64, ch_out=64) # for skip41: 64 out channels
        self.skip322 = simple_conv(ch_in=64, ch_out=64) # for skip41: 64 out channels
        ...
        self.skip21 = simple_conv(ch_in=32, ch_out=32) # for enc22: 32 out channels
        self.skip221 = simple_conv(ch_in=32, ch_out=32) # for skip51: 32 out channels
        self.skip222 = simple_conv(ch_in=32, ch_out=32) # for skip51: 32 out channels
        ...
        self.skip11 = simple_conv(ch_in=16, ch_out=16) # for enc12: 16 out channels
    ...
    def forward(self, dem: torch.Tensor, rain: torch.Tensor) -> Dict[str, torch.Tensor]:
        ...
        ## Skip convolutions
        enc1_skip11 = self.skip11(enc1) # 16 out_channels
        enc1_skip121 = self.skip121(enc1_skip11) # 16 out_channels
        enc1_skip122 = self.skip122(enc1_skip11) # 16 out_channels
        enc1_skip12cat = torch.cat([enc1_skip121, enc1_skip122], dim=1) # 16 out_channels
        enc1_skip131 = self.skip131(enc1_skip12cat) # 16 out_channels
        enc1_skip132 = self.skip132(enc1_skip12cat) # 16 out_channels
        enc1_skip13cat = torch.cat([enc1_skip131, enc1_skip132], dim=1) # 16 out_channels
        enc1_skip14 = self.skip14(enc1_skip13cat) # 16 out_channels
